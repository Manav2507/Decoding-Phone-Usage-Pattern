...
def main():
    ...
    if menu == "Overview":
        ...
        image = Image.open("./image/gender.png")
        ...
        image = Image.open("./image/OS_device.png")
        ...
        image = Image.open("./image/phone_brand_location.png")
        resized_image = image.resize((800, 600))
        st.image(resized_image)
        ...
        image = Image.open("./image/phone_usage_phone_brand.png")
        resized_image = image.resize((800, 600))
        st.image(resized_image)
        ...
        st.subheader("Delivery Time Distibution over Data")
        image = Image.open("./image/phone_usage.png")
        resized_image = image.resize((800, 600))
        st.image(resized_image)
        # st.text("According to the histogram plot, delivery agents often take between 60 and 160 minutes for deliveries.")
        ...
        st.subheader("Delivery Time Distibution over Data")
        image = Image.open("./image/purpose_phone.png")
        resized_image = image.resize((800, 600))
        st.image(resized_image)
        # st.text("According to the histogram plot, delivery agents often take between 60 and 160 minutes for deliveries.")
